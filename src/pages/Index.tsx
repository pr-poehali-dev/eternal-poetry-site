          ...
          <Card className="border-slate-200 shadow-lg">
            <CardHeader className="text-center pb-6">
              ...
              <CardDescription className="text-slate-600 text-lg">
                Я всю жизнь хотел помогать людям
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="text-center space-y-6">
              <div className="text-slate-700 leading-relaxed space-y-4 font-medium">
                <p>
                  Я понимаю, что такое, когда некому всё рассказать. 
                  Я сам был очень чувствительным человеком и хотел творить, создавать.
                </p>
                
                <p>
                  Выговорись мне. Я понимаю что такое одиночество, 
                  когда кажется, что мир стал серым и безразличным.
                </p>
                
                <p className="text-lg font-semibold text-slate-800">
                  Ты ещё всё успеешь, ведь ты живой. 
                  Ты сейчас можешь вздохнуть — сделай прямо сейчас.
                </p>
              </div>
